...
//* favorite color */
{
    ...
    "label": "OFF",
    "mode": "contact",
    "ontouchstart": "knbbValue.changeValue(0); knbrValue.changeValue(0); knbgValue.changeValue(0); knbr.setValue(0); knbg.setValue(0); knbb.setValue(0); oscManager.sendOSC(['/modd', 'f', 1.007]); oscManager.sendOSC(['/knbr', 'f', 0.001]); oscManager.sendOSC(['/knbg', 'f', 0.001]); oscManager.sendOSC(['/knbb', 'f', 0.001])",
},
/* MODE Buttons*/
{
    "name" : "modd0",
